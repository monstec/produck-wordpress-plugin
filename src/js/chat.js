...
function initChatJs() {
    setTimeout(function () {
        jQuery('#produck-chat-block-home').not('quacks-active').find('.produck-chat-link').addClass('quacks-pulse');
        setTimeout(function () {
            jQuery('#produck-chat-block-home').not('quacks-active').find('.produck-chat-link').removeClass('quacks-pulse');
        }, 10000);
    }, 20000);
