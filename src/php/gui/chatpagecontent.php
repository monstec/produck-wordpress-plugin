...
class ChatPageContent implements DynamicPageContent
{
    protected $connector;
    protected $title;
    protected $content;
...
?>
                ...
                <div id="stats-wrapper">
                    ...
                    <div class="quack-date">
                        <?php if (isset($quackData['lastModifiedTime'])) : ?>
                            ...
                            ?>
                            <span class="published" datetime="<?php echo htmlspecialchars($quackData['lastModifiedTime']); ?>" title="i18next.t('text.last_update_on', { date: <?php echo $formattedModifiedTime ?>})}" ><?php echo htmlspecialchars($formattedModifiedTime); ?></span><i title="Zuletzt aktualisiert am <?php echo htmlspecialchars($formattedModifiedTime); ?>" class="material-icons">autorenew</i>
                        <?php else : ?>
                            <?php
                    ...
                    <div class="share-brand">
                        <div class="share" data-i18n="[title]text.share_page">
                ...
                <div id="quack-content-body">
                    <div id="quack-content-wrapper" data-quack-data="<?php echo htmlspecialchars($quackData['id']); ?>">
                        ...
                        <div class="interaction-bar share-brand bottom">
                            ...
                            <div class="share" data-i18n="[title]share_page,[prepend]text.share">Share<i class="material-icons">share</i></div>
                        </div>
                                ...
                                <div id="author-details-block" class="info-card" data-author-id="<?php echo htmlspecialchars($quackData['authorId']); ?>">
                                    <div class="card-wrapper <?php echo !empty($quackData['longDescr']) ? 'long-version' : 'short-version'; ?>">
                                        <div class="card-image-block">
                                            ...
                                            ?>
                                                <a class="image-wrapper" target="_blank" href="https://produck.de/profile/<?php echo htmlspecialchars($quackData['authorId']); ?>"><img src="<?php echo htmlspecialchars($imagePath); ?>" loading="lazy" class="image" alt="Autoren Portrait"></a>
                                            <?php else : ?>
                                                <a class="image-wrapper" target="_blank" href="https://produck.de/profile/<?php echo htmlspecialchars($quackData['authorId']); ?>"><img src="<?php ProduckPlugin::getImageURL('ducky.png') ?>" loading="lazy" class="image-placeholder" alt="Autoren Portrait"></a>
                                            <?php endif; ?>
                                        </div>
                                        <div class="card-text-block">
                                            <a class="author-name" target="_blank" href="https://produck.de/profile/<?php echo htmlspecialchars($quackData['authorId']); ?>"><span><?php echo !empty($quackData['fullName']) ? htmlspecialchars($quackData['fullName']) : htmlspecialchars($quackData['nickname']); ?></span></a>
                                            <?php if (!empty($quackData['specDescr'])) : ?>
                                                <a class="author-expertise" target="_blank" href="https://produck.de/profile/<?php echo htmlspecialchars($quackData['authorId']); ?>"><span data-i18n="quackpage.speciality"></span>&nbsp;<span><?php echo htmlspecialchars($quackData['specDescr']); ?></span></a>
                                            <?php else : ?>
    ...
    private function renderChat($quackData, $quackId, $quackLink, $quackTitle, $tags, $views, $quackity)
    {
        ...
        $expertNickname = $quackData['nickname'];
    ...
    ?>
        ...
        <div id="quackSingleContainer" class="main" itemprop="mainEntity" itemscope itemtype="https://schema.org/Article" data-quack-id="<?php echo htmlspecialchars($quackData['quackId']); ?>" data-chat-id="<?php echo htmlspecialchars($quackData['chatId']); ?>">
            <section id="quack-info-bar">
                <div id="quack-category-block">
                    <a class="chip active" data-i18n="text.external_chat">Externer Chat</a>
                </div>
                <div id="stats-wrapper">
                    <div class="votes" data-i18n="[title]text.rating" itemscope itemtype="https://schema.org/CreativeWorkSeries">
                        <meta itemprop="headline name" content="<?php echo htmlspecialchars($quackData['title']); ?>" />
                    ...
                    <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter" class="views" data-i18n="[title]text.views">
                        <div itemprop="interactionType" href="https://schema.org/WatchAction" class="mini-counts">
                            ...
                            <span itemprop="userInteractionCount" name="views" content="<?php $views; ?>" views="<?php $views; ?> views"><?php $views; ?></span>
                        </div>
                        <div class="flex-box"><i class="material-icons">visibility</i></div>
                    </div>
                    <div class="quack-date" data-i18n="[title]text.answers_on">
            ...
            <section id="quack-container">
                <div id="quacklist-wrapper" class="flush-left">
                    <div id="quack-overview-list" quack-data="<?php $quackId; ?>" >
                        <div class="answer">
